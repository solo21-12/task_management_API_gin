...
func (m *MockSignUpUseCase) CreateAccessToken(user domain.UserDTO) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSignUpUseCaseMockRecorder) CreateAccessToken(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAccessToken", reflect.TypeOf((*MockSignUpUseCase)(nil).CreateAccessToken), user)
}
