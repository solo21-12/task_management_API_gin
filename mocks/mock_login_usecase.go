...
func (m *MockLoginUseCase) CreateAccessToken(user domain.UserDTO) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockLoginUseCaseMockRecorder) CreateAccessToken(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAccessToken", reflect.TypeOf((*MockLoginUseCase)(nil).CreateAccessToken), user)
}
